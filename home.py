...
<div class='eco-card'>
  ...
  <b style='color:var(--accent-primary);'>시간 · 탄소 · 비용</b> 세 가지 자원을 관리해보세요.<br><br>
...
<div class='eco-card'>
  ...
  <b style='color:var(--accent-primary);'>용의자 영상 · 단서 수집 · 조별 추리</b>를 통해<br>
...
<div class='eco-card'>
  ...
  우리 반 친구들의 응답이 <b style='color:var(--accent-primary);'>실시간 네트워크 그래프</b>로 펼쳐집니다.<br><br>
...
<div class='eco-card' style='text-align:center;'>
  ...
  <b style='color:var(--accent-primary);'>네트워크 사이언스</b>
  <p style='color:var(--text-muted); font-size:.87rem; margin-top:.5rem;'>
...
<div class='eco-card' style='text-align:center;'>
  ...
  <b style='color:var(--accent-primary);'>데이터 사이언스</b>
  <p style='color:var(--text-muted); font-size:.87rem; margin-top:.5rem;'>
...
<div class='eco-card' style='text-align:center;'>
  <div style='font-size:2rem;'>🌏</div>
  <b style='color:var(--accent-primary);'>환경 행동 이론</b>
  <p style='color:var(--text-muted); font-size:.87rem; margin-top:.5rem;'>
