...
NODE_POS = {
    "제주공항":       (0.476, 0.820),  # 핀 위쪽 (하늘)
    "협재해변":       (0.110, 0.590),  # 핀 왼쪽 (바다)
    "대정중학교":     (0.210, 0.240),  # 핀 왼쪽 아래
    "서귀포치유의숲": (0.660, 0.220),  # 핀 오른쪽 아래
    "성산일출봉":     (0.960, 0.628),  # 핀 오른쪽 (바다)
    "함덕해변":       (0.758, 0.930),  # 핀 위쪽 (바다)
}
