...
network4 = st.Page("pages/3_4survey4.py", title="4반 환경행동 네트워크", icon="📊")
...
SECTIONS = [
    ...
    ("Network", [
        (game1, "삼다수 에코 레이스", "🎮", ["초등", "중등", "고등"]),
        (game2, "살충사건 수사본부", "🪲", ["초등", "중등"]),
        (game3, "제주 생태계 밸런스", "🌋", ["중등", "고등", "대학·성인"]),
        (game4, "픽셀 에코시티", "🏙️", ["초등", "중등", "고등"]),
    ...
    ("Survey", [
        ...
        (network4, "4반 환경행동 네트워크", "📊", ["중등", "고등", "대학·성인"]),
    ]),
    ("Workshop", [
        (work1, "데이터로 읽는 국제무역", "🌐", ["대학·성인"]),
        (work2, "데이터로 읽는 특허", "📜", ["대학·성인"]),
    ]),
]
